...
LABEL_12:
				...
				switch (pDestroy.part)
				{
					...
					case YBLOCK_TNA_1:
							...
							Sub_806FFB0_Panel_PutBG_Save(*(unsigned short*)(2 * (pDestroy.yp * Layer1_Width + pDestroy.xp) + Layer1_DecompressedDataPointer) + 1, pDestroy.yp, pDestroy.xp);
...
YBLOCK_KA_2_BREAK:
					...
					case YBLOCK_NA_AW:
						while ( pDestroy.part != YBLOCK_NA_AW_L ) {
							--pDestroy.xp;
							pDestroy.part = *(unsigned short*)(2 * *(unsigned short*)(2 * (pDestroy.yp * Layer1_Width + pDestroy.xp) + Layer1_DecompressedDataPointer) + CurrentTileset_EventIdTablePointer);
						}
YBLOCK_NA_AW_BREAK:
					...
					case YBLOCK_NA_AH:
						while ( pDestroy.part != YBLOCK_NA_AH_U ) {
							--pDestroy.yp;
							pDestroy.part = *(unsigned short*)(2 * *(unsigned short*)(2 * (pDestroy.yp * Layer1_Width + pDestroy.xp) + Layer1_DecompressedDataPointer) + CurrentTileset_EventIdTablePointer);
						}
YBLOCK_NA_AH_BREAK:
				...
				case YBLOCK_NA_AWH:
						while ( 1 ) {
							--pDestroy.xp;
							pDestroy.part = *(unsigned short*)(2 * *(unsigned short*)(2 * (pDestroy.yp * Layer1_Width + pDestroy.xp) + Layer1_DecompressedDataPointer) + CurrentTileset_EventIdTablePointer);
							if ( pDestroy.part == YBLOCK_NA_AWH_LU )
								goto YBLOCK_NA_AWH_BREAK;
							if ( pDestroy.part == YBLOCK_NA_AWH_L )
...
YBLOCK_NA_AWH_BREAK:
						...
						while ( 1 ) {
							while ( 1 ) {
								...
								++pDestroy.xp;
								pDestroy.part = *(unsigned short*)(2 * *(unsigned short*)(2 * (pDestroy.yp * Layer1_Width + pDestroy.xp) + Layer1_DecompressedDataPointer) + CurrentTileset_EventIdTablePointer);
								if ( pDestroy.part != YBLOCK_NA_AWH )
									break;
							}
